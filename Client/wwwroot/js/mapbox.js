export function loadMap() {
    ...
    const markerHubertiere = new mapboxgl.Marker({ color: "#F9B686" }).setLngLat([-1.6880435571812855, 46.82575275601642]).setPopup(popupHubertiere).addTo(map);
    ...
    const markerCharrie = new mapboxgl.Marker({ color: "#F9B686" }).setLngLat([-1.747576653853278, 46.866937776056105]).setPopup(popupCharrie).addTo(map);
